...
function WordBox({wordSet}:{wordSet:IWordSet}) {
  ...
  return (
    <div className='w-[90%] max-w-[300px] max-h-[450px] h-[60%] border-4 border-gray-600/50 rounded-3xl flex flex-col bg-gray-200 '>
        <h1 className='flex justify-center items-center h-[100px] text-3xl py-4 uppercase font-bold bg-slate-800 text-gray-200 w-full border-t-20 border-slate-800 rounded-t-[1.3rem]'>{wordSet.word}</h1>
